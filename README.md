...
- **16 categories** including Food (Self / Family / Friends separately), Travel, Mobile Recharge, Electronics, AI & Tech Subscriptions
...
- **Backup & restore** — JSON backup and CSV export for Excel
- **100% offline & private** — no server, no account; all data stays in your phone's local storage

## 📱 Install on iPhone

1. Open the GitHub Pages link of this repo in **Safari**
2. Tap **Share → Add to Home Screen**
3. Done — it works like a native app, fully offline after first load
